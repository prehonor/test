...
Pointer<CStockInfoArray> queryAllCompanies() => _bindings.queryAllCompanies();
...
const String _libName = 'test';

/// The dynamic library in which the symbols for [TestBindings] can be found.
...
final TestBindings _bindings = TestBindings(_dylib);
